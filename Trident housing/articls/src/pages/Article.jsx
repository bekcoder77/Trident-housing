...
function Article() {
  ...
  return (
   ...
   {data &&   <div className="about pb-20 mt-5 flex justify-between px-20 text-[#00204A]">
      <div className="left w-[45%]">
        ...
        <h2 className="info text-xl ">{data.info}</h2> <br />
        <h2 className="info text-xl ">{data.infos}</h2> <br />
        <h2 className="info text-xl ">{data.infos2}</h2> <br />
        <h2 className="info text-xl ">{data.infos3}</h2>
      </div>
      <div className="imagsds w-[45%]">
        <img className="w-[100%] h-[700px] object-cover" src={data.image} alt="" />
      </div>
    </div>}
        ...
        {cardInfo.map((item)=>{
             return (
              <div className="card py-5 px-3  mt-10 w-[500px] min-h-[200px] gap-4">
                 <img
                    className="w-[180px] mb-5 object-cover"
                    src={item.img}
                    alt=""
                  />
                <div className="text">
